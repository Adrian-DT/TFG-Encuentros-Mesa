<?php
@session_start();
if (isset($_SESSION["id"])) header("Location: ../pages/registro_partidas.php");
?>
...
<head>
    ...
    <title>Registro de Usuario | RDM</title>
    ...
    <main class="mt-2 py-5">
        ...
        <div class="container d-flex text-center justify-content-center">
            <form action="../functions/controlador_formularios.php" method="POST">
                ...
                <div class="form-group">
                    <label for="contraseña_verif">Repita contraseña:</label>
                    <input type="password" class="form-control form-control-sm" id="contraseña_verif" name="contraseña_verif">
                </div>
                <button type="submit" class="btn btn-success my-4" name="registro">Registrarse</button>
            </form>
        </div>
    </main>
