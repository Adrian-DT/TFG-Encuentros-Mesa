                                        ...
                                        <?php foreach ($partidas as $partida): ?>
                                            <tr>
                                                ...
                                                if (!isset($_SESSION["id"])) {
                                                    ...
                                                    <td><a class='text-primary tooltip-trigger' data-bs-toggle='tooltip' title='Salir de la partida' href='../functions/controlador_formularios.php?no_participar=" . $partida["id_partida"] . "'><i class='bi bi-arrow-bar-left text-danger'></i></a></td></td>
                                                    <td><a class='text-primary tooltip-trigger' data-bs-toggle='tooltip' title='Información de la partida' href='../pages/info_partida.php?info=" . $partida["id_partida"] . "'><i class='bi bi-info-square text-info'></i></a></td>";
                                                    ...
                                                    <td><a class='text-danger tooltip-trigger' data-bs-toggle='tooltip' title='Eliminar partida' href='../functions/controlador_formularios.php?eliminar=" . $partida['id_partida'] . "&user=" . $_SESSION["id"] . "'><i class='bi bi-trash3'></i></a></td>
                                                    <td><a class='text-primary tooltip-trigger' data-bs-toggle='tooltip' title='Información de la partida' href='../pages/info_partida.php?info=" . $partida["id_partida"] . "'><i class='bi bi-info-square text-info'></i></a></td>";
