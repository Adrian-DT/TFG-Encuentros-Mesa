...
foreach ($partidas as $partida) {
    if ($partida["id_partida"] == $_GET["id_partida"]) {
        $id_partida = $partida["id_partida"];
        $id_juego = $partida["id_juego"];
        $nombre_juego_partida = $partida["nombre_juego"];
        $lugar = $partida["lugar"];
        $participantes = $partida["participantes"];
        $ganador = $partida["ganador"];
        $fecha = $partida["fecha_partida"];
        $comentarios = $partida["comentarios"];
    }
}
?>
...
<head>
    ...
    <title>Editar Partida | RDM</title>
...
<body>
    ...
    <main class="mt-2 py-1 mb-5">
        <h1 class="text-center py-2">Edita tu partida</h1>
        <div class="container-fluid d-flex text-center justify-content-center">
            <form action="../functions/controlador_formularios.php" method="POST" class="container w-75 mx-auto pb-2">
                ...
                <div class="row g-3">
                    <div class="col-12">
                        <button type="submit" class="btn btn-success mt-3" name="editar_partida">Editar Partida</button>
                    </div>
                </div>
            </form>
        </div>
